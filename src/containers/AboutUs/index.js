...
import { about, anum, javeria, maryam, minal, profile,about1 } from "../../constants/Images";
    ...
    <Box component="div">
      ...
      <Container>
        <Grid container marginTop={2} spacing={2} justifyContent="space-between">
          ...
          <Grid item xs={12} md={5.5}>
            <img src={about1} alt="about" style={{ width: "100%", borderRadius: "20px" }} />
          </Grid>
        </Grid>
        ...
        <Box component="div" sx={{ marginTop: "40px" }}>
          ...
          >
            Your next level Product developement company assets
          </Typography> */}
            ...
            {employeesData.map((employee) => {
              return (
                <Grid item xs={12} md={4}>
                  ...
                  >
                    <img src={employee.image} style={{ width: "100%", height: "350px" }} />
                    {/* <Typography
                      variant="h2"
                      sx={{
                        fontSize: "18px !important",
