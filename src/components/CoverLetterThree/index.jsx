            ...
            <Page size="A4" style={{borderLeft:"13px solid green"}}>
                <View style={styles.top_section}>
                    ...
                    {/* <View style={styles.second}>
                        ...
                        <Text style={styles.headings_data}>80 Gold St Apt#19M, NY 10038, New York, United States</Text>
                        </View>
                        <View style={styles.flex}>
                        <Text style={styles.heading}>Contact:</Text>
                        <Text style={styles.headings_data}>03242665257-qaziwaqas144@gmail.com</Text>
                        </View>
                        </View>
