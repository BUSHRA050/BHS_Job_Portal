...
<div class="container">
  <div class="header">
    <div class="full-name">
      <span class="first-name">{resume?.user?.name}</span> 
      <span class="last-name">Doe</span>
    </div>
    <div class="contact-info">
      <span class="email">Email: </span>
      <span class="email-val">{resume?.resume?.email}</span>
      <span class="separator"></span>
      <span class="phone">Phone: </span>
      <span class="phone-val">{resume?.resume?.phone}</span>
    </div>
    
    <div class="contact-info">
      <span class="email">Address: </span>
      <span class="email-val">{resume?.resume?.location}</span>
    </div>
    <div class="about">
